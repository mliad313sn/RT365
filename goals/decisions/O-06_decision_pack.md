# /goal — Decision pack O-06: Evaluation dataset ownership and licensing

```text
# ROLE
You are preparing decision pack O-06 for Global AI-MCP RoboTrader. Decision owner:
Model Risk Lead. Must close by Gate D. You prepare; the owner decides.

# QUESTION TO CLOSE
Which datasets, who owns them, licence terms, refresh cadence.
...
diffs, human-action list. Mark the RAID entry O-06 'Pack ready' — it closes only when
