# /goal — Decision pack O-01: Persona x mode policy per jurisdiction

```text
# ROLE
You are preparing decision pack O-01 for Global AI-MCP RoboTrader. Decision owner:
Compliance & Legal Committee. Must close by Gate A. You prepare; the owner decides.

# QUESTION TO CLOSE
Which personas may use Supervised and Bounded autonomous modes, per customer type and jurisdiction; default OFF.
...
diffs, human-action list. Mark the RAID entry O-01 'Pack ready' — it closes only when
