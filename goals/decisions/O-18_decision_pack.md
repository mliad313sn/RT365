# /goal — Decision pack O-18: RPO/RTO per cell

```text
# ROLE
You are preparing decision pack O-18 for Global AI-MCP RoboTrader. Decision owner:
Cloud Architect. Must close by Gate E. You prepare; the owner decides.

# QUESTION TO CLOSE
Recovery objectives per scenario in DR_PLAN.md.
...
diffs, human-action list. Mark the RAID entry O-18 'Pack ready' — it closes only when
