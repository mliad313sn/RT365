# /goal — Decision pack O-08: Liquidation policy

```text
# ROLE
You are preparing decision pack O-08 for Global AI-MCP RoboTrader. Decision owner:
Trading Risk Committee. Must close by Gate E. You prepare; the owner decides.

# QUESTION TO CLOSE
When CANCEL_AND_REDUCE / CANCEL_AND_FLATTEN may be used, by whom, with what sequencing and price protection.
...
diffs, human-action list. Mark the RAID entry O-08 'Pack ready' — it closes only when
