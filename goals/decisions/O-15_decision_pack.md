# /goal — Decision pack O-15: On-call model and support hours per market

```text
# ROLE
You are preparing decision pack O-15 for Global AI-MCP RoboTrader. Decision owner:
SRE Lead, Support Lead. Must close by Gate F. You prepare; the owner decides.

# QUESTION TO CLOSE
Coverage windows aligned to market sessions; incident contacts.
...
diffs, human-action list. Mark the RAID entry O-15 'Pack ready' — it closes only when
