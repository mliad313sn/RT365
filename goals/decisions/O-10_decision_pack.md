# /goal — Decision pack O-10: DPIA per launch jurisdiction

```text
# ROLE
You are preparing decision pack O-10 for Global AI-MCP RoboTrader. Decision owner:
Privacy Lead. Must close by Gate D. You prepare; the owner decides.

# QUESTION TO CLOSE
Complete DPIA for the first jurisdiction; template for others.
...
diffs, human-action list. Mark the RAID entry O-10 'Pack ready' — it closes only when
