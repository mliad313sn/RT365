# /goal — Decision pack O-05: Model providers, hosting and data-processing terms

```text
# ROLE
You are preparing decision pack O-05 for Global AI-MCP RoboTrader. Decision owner:
Model Risk Lead, Privacy Lead. Must close by Gate B. You prepare; the owner decides.

# QUESTION TO CLOSE
Which LLM/ML providers, API vs self-hosted, data residency and retention terms, fallback provider.
...
diffs, human-action list. Mark the RAID entry O-05 'Pack ready' — it closes only when
