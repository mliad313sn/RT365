# /goal — Decision pack O-04: Service framework choice

```text
# ROLE
You are preparing decision pack O-04 for Global AI-MCP RoboTrader. Decision owner:
ARB. Must close by Gate B. You prepare; the owner decides.

# QUESTION TO CLOSE
FastAPI vs alternative typed framework; criteria: OpenAPI generation, typing, performance, team skills.
...
diffs, human-action list. Mark the RAID entry O-04 'Pack ready' — it closes only when
