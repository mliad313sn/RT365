# /goal — Decision pack O-07: Numeric risk thresholds per asset class and jurisdiction

```text
# ROLE
You are preparing decision pack O-07 for Global AI-MCP RoboTrader. Decision owner:
Trading Risk Committee. Must close by Gate C. You prepare; the owner decides.

# QUESTION TO CLOSE
Fill LIMIT_MATRIX.md at all five levels for each metric, per asset class.
...
diffs, human-action list. Mark the RAID entry O-07 'Pack ready' — it closes only when
