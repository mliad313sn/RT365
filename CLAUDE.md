...
Lifecycle/PMO: Meridian IT-PMO (mliad313sn/Meridian) holds the portfolio, gates, RAID, decisions and the Product Owner's weekly; ledgers stay the truth; run `make pmo-sync` after ledger changes (docs/PMO.md, ADR-017).
