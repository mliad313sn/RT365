# /goal — Master Delivery Orchestrator (00_GOAL_ORCHESTRATOR)

Supersedes blueprint `00_GOAL_ORCHESTRATOR.md` by embedding the committee protocol. No authority rule of the blueprint is changed.
