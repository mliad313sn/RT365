...
| H-31 | File the Meridian value requirements V-1..V-15 upstream, through Meridian's own request register (docs/requests/rt365.json) or as issues on mliad313sn/Meridian | PMO | Product Owner (human) | — | docs/PMO_MERIDIAN_ASSESSMENT.md §8; IMPROVEMENT_REGISTER §D2; **pack prepared 2026-09-08 on branch `docs/meridian-report-value`: docs/REPORTS/PMO_MERIDIAN_REPORT_VALUE.md and docs/REPORTS/meridian_requests_v2.json (REQ-14..REQ-28, all `proposed`, three new requirements V-13..V-15)** | requests visible in Meridian's register with an upstream owner and status | | Open — prepared, not filed |
