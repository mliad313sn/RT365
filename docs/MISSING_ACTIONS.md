...
| H-31 | File the Meridian value requirements V-1..V-12 upstream, through Meridian's own request register (docs/requests/rt365.json) or as issues on mliad313sn/Meridian | PMO | Product Owner (human) | — | docs/PMO_MERIDIAN_ASSESSMENT.md §8; IMPROVEMENT_REGISTER §D2 | requests visible in Meridian's register with an upstream owner and status | | Open |
