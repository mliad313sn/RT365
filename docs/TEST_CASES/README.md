...
ID scheme: TC-<area>-<nnn>: ID identity · BR broker · MD market data · AI MCP/AI · RK risk · AP approval · EX execution · RC reconciliation · CP compliance · KS kill switch · NET network policy · OB observability · SEC secrets · SC supply chain · TEN tenancy · AUD audit · PERF performance · A11Y accessibility · DR disaster recovery.
