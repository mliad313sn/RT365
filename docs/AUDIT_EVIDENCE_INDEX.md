...
| 25 | A | Product Owner appointed (acting) with mandate, segregation and RACI rows | appointment record | PRODUCT_OWNER.md; goals/00_product_owner.md; D-035; H-23 pending | Delivery Orchestrator (AI) | | 2026-09-07 | |
...
| 28 | B | Installable distribution: wheel/sdist, Linux one-file executable, installers, release workflow (Windows .exe) | quartet + build logs | TEST_CASES/TC-PKG.md; installer/; dist/ built locally (wheel installed in a clean venv and self-checked from /tmp; Linux binary SHA-256 recorded in SESSIONS/ORCH_2026-09-07_product_owner_agents_packaging.md); Windows run [Open: H-24] | SRE Lead | | 2026-09-07 | |
