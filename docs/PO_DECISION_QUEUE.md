...
| O-19 | C | Deputies for emergency authority (second human for two-person controls) | Trading Risk Committee | goals/decisions/O-19_decision_pack.md | not yet convened | pending | **pending** | |
...
| H-02 | A | Ratify committee structure and decisions D-001..D-004 | Governance | Executive Steering | Product Council + CAB | **pending** | Open |
| H-03 | A | Choose first jurisdiction cell | Strategy | Product Director + Compliance | Product Council + Compliance & Legal Committee | **pending** | Open |
