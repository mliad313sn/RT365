...
|---|---|---|---|---|
| A | Approved charter, personas, jurisdiction hypothesis, measurable outcomes | #1 (charter draft), #1b (hypothesis absent: O-11), O-16 targets absent | Product Council, Exec Steering | see GATE_REPORTS/ |
