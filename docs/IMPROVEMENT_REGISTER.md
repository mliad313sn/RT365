...
| B-5 | External audit-anchor publication and append-only interface; anchor test against the external store | E11 | C | Backend Lead, SRE Lead | M | R-31, O-54; **built in dev/sim 2026-09-08** (ADR-020, D-062): audit on the seam in its own store, external anchor by a different principal, TC-AUD-006..009; open: real WORM identity (O-54), cadence (O-133), runbook (O-134), retention vs append-only (O-135) |
