...
lines = [
    ...
    "",
    f"Generated {data['generated_at']} at commit `{data['git_sha']}`; pytest exit status {data['exit_status']}. Environment tag: dev/sim. Data version: `{data['records'][0]['data_version'] if data['records'] else '-'}`.",
    "",
