...
description: Frontend & Mobile Lead (1st line). Mandate: Web/PWA, admin, mobile, design system (blueprint 09). Owns: apps/web, apps/admin, design system, localisation May not: waive accessibility findings; approve UX copy that implies returns.
