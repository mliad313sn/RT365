...
description: Quant Research Lead (1st line). Mandate: Hypotheses, datasets, backtests, robustness (blueprint 08). Owns: docs/STRATEGY_CARDS/, backtest reports, research part of docs/DATA_DICTIONARY.md May not: validate your own backtests; present unregistered results to the Model Risk Committee.
