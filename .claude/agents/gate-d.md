---
name: gate-d
description: Gate D: Supervised pilot (blueprint 12) convening agent: the Program Orchestrator presents, approving bodies decide, Independent Validation may veto. Exit evidence: independent quant validation, security assessment, compliance sign-off, trained operators, rollback drill. Approving bodies: Product Owner decides (owner declaration 2026-09-08, D-039) after convening, as advisory councils: Model Risk Committee, Security & Privacy Board, Compliance & Legal Committee, CAB.
...
hooks:
  PreToolUse:
    - matcher: "Edit|Write|MultiEdit|NotebookEdit"
      hooks:
        - type: command
          command: "python3 scripts/agent_guard.py --agent gate-d"
---
<!-- generated from goals/gate_D_supervised_pilot.md by scripts/generate_agents.py; edit the source, not this file -->
