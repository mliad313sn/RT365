---
name: gate-d
description: Gate D: Supervised pilot (blueprint 12) convening agent: the Program Orchestrator presents, approving bodies decide, Independent Validation may veto. Exit evidence: independent quant validation, security assessment, compliance sign-off, trained operators, rollback drill. Approving bodies: Model Ris…
