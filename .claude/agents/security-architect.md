...
hooks:
  PreToolUse:
    - matcher: "Edit|Write|MultiEdit|NotebookEdit"
      hooks:
        - type: command
          command: "python3 scripts/agent_guard.py --agent security-architect"
---
<!-- generated from goals/13_security_architect.md by scripts/generate_agents.py; edit the source, not this file -->
