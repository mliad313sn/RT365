...
description: Integration Architect (1st line). Mandate: Event bus, schema registry, adapters, idempotency (blueprint 03). Owns: contracts/api/API_OPENAPI.yaml, contracts/events/, docs/EVENT_CATALOG.md May not: approve broker certification alone; change risk contracts without 2nd-line review. Expertise: Integration lead for exchange and broker connectivity and event buses; has run schema registries and idempotent messaging at scale.
...
<!-- expertise profile from goals/profiles/12_integration_architect.md -->
